      ...
      <main className="relative pt-32 pb-24 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeIn} className="border-4 border-black bg-white p-8 md:p-16 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)] flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter leading-none mb-6" style={{ fontFamily: "var(--font-serif)" }}>
                The Path <br />
                <span className="italic decoration-black underline underline-offset-8">to Growth.</span>
              </h1>
              <p className="text-xl font-medium opacity-80">
                A simple guide to the features we are building and what is coming next for Stereo Mind.
              </p>
            </div>
            <div className="bg-black text-white p-6 font-code text-xs flex flex-col gap-2 shadow-[8px_8px_0px_0px_rgba(243,243,243,1)]">
              ...
              <div className="mt-4 border-t border-white/20 pt-4">
                ...
                <div className="mt-2 opacity-50">FOUNDATION COMPLETE...</div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.section variants={fadeIn} className="space-y-8">
            <h2 className="text-3xl font-bold uppercase font-code tracking-tighter">I. Growth Phases</h2>
            ...
            <div className="grid gap-12 border-l-4 border-black pl-8 ml-4">
              ...
              <div className="relative">
                ...
                <div className="border-2 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold uppercase font-code underline decoration-2 underline-offset-4">Phase: Foundation (v0.1.0)</h3>
                    <span className="bg-green-100 text-green-800 border-2 border-green-800 px-3 py-1 text-[10px] font-bold uppercase">Restored & Active</span>
                  </div>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      <p className="text-sm font-medium opacity-70">Focus: Core features to help you start tracking your work today.</p>
                      <ul className="space-y-2">
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <CheckCircle2 className="w-4 h-4 text-green-600" />
                          Dashboard & Project Management (CRUD)
                        </li>
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <CheckCircle2 className="w-4 h-4 text-green-600" />
              ...
              <div className="relative">
                ...
                <div className="border-2 border-black bg-white/50 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold uppercase font-code opacity-80">Phase: Growth Features (v0.2.0)</h3>
                    <span className="bg-blue-100 text-blue-800 border-2 border-blue-800 px-3 py-1 text-[10px] font-bold uppercase tracking-tight">In Development</span>
                  </div>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      <p className="text-sm font-medium opacity-70 italic">Focus: Making growth fun and visual.</p>
                      <ul className="space-y-2 opacity-60">
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Clock className="w-4 h-4" />
                          Visual Idea Maps & Knowledge Graphs
                        </li>
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Clock className="w-4 h-4" />
                          Skill Mastery & RPG-style Leveling
                        </li>
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Clock className="w-4 h-4" />
                          Daily Streaks & Consistency Charts
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="relative">
                ...
                <div className="border-2 border-black bg-white/30 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                  <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold uppercase font-code opacity-60">Phase: Ecosystem (v1.0)</h3>
                    <span className="border-2 border-black/20 px-3 py-1 text-[10px] font-bold uppercase text-black/40">Long Term</span>
                  </div>
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      <p className="text-sm font-medium opacity-60 italic">Focus: Connecting your entire life.</p>
                      <ul className="space-y-2 opacity-50">
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Terminal className="w-4 h-4" />
                          Connect to external tools (IDEs, Health apps)
                        </li>
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Activity className="w-4 h-4" />
                          Habit Building Loops & Reminders
                        </li>
                        <li className="flex items-center gap-3 text-sm font-bold">
                          <Zap className="w-4 h-4" />
                          AI Growth Insights & Suggestions
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <motion.section variants={fadeIn} className="grid md:grid-cols-2 gap-12">
            <div className="border-2 border-black bg-secondary p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              <h2 className="text-2xl font-bold uppercase font-code mb-6">Core Values</h2>
              <div className="space-y-6 font-code text-xs">
                <div className="space-y-1">
                  <p className="font-bold border-b border-black pb-2 mb-2">PRIVACY FIRST</p>
                  <p>• Your data is encrypted and private</p>
                  <p>• No tracking, no ads, no selling info</p>
                </div>
                <div className="space-y-1">
                  <p className="font-bold border-b border-black pb-2 mb-2">OPEN SOURCE</p>
                  <p>• The code is public and transparent</p>
                  <p>• Community driven improvements</p>
                </div>
                <div className="space-y-1">
                  <p className="font-bold border-b border-black pb-2 mb-2">DATA OWNERSHIP</p>
                  <p>• Export your data anytime in JSON/CSV</p>
                  <p>• You own your mind, you own your data</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center text-center border-4 border-black p-12 bg-white shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              ...
              <p className="text-lg font-medium mb-12">
                We are building a tool that respects your focus and fuels your growth.
              </p>
          ...
          <footer className="pt-16 pb-8 border-t-2 border-black flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-bold font-code opacity-50 uppercase tracking-widest">
            <div>STEREO MIND PROTOCOL // 2026 // ROADMAP_VER: 1.0</div>

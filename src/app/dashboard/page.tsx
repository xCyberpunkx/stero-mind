        ...
        <div className="min-h-screen bg-background text-foreground font-display selection:bg-black selection:text-white">
          ...
          <main className="relative pt-32 pb-24 px-6 max-w-7xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div className="flex gap-4">
                  <Link href="/whitepaper">
                    <Button variant="outline" className="border-2 border-border rounded-none font-code font-bold text-xs shadow-[4px_4px_0px_0px_var(--border)] hover:bg-secondary transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Profile Card */}
              <div className="md:col-span-1 border-2 border-border bg-secondary/30 p-8 shadow-[8px_8px_0px_0px_var(--border)]">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="border-2 border-border bg-background p-3 font-code font-bold text-xs uppercase">
                      {profile.goal}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile.interests?.map((interest: string) => (
                        <span key={interest} className="border border-border px-2 py-1 text-[9px] font-bold uppercase bg-background">
                          {interest}
                        </span>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {profile.tools?.map((tool: string) => (
                        <span key={tool} className="border border-border px-2 py-1 text-[9px] font-bold uppercase bg-background">
                          {tool}
                        </span>
                ...
                <div className="mt-8 pt-8 border-t border-border/10">
                  <Button className="w-full bg-black text-white hover:bg-background hover:text-black border-2 border-border rounded-none shadow-[4px_4px_0px_0px_var(--border)] active:shadow-none h-12 font-code font-bold text-xs">
                    EDIT CORE_SYSTEM
                  </Button>
                </div>
              </div>
              ...
              <div className="md:col-span-2 border-2 border-border bg-background p-12 shadow-[12px_12px_0px_0px_var(--border)] flex flex-col items-center justify-center text-center relative overflow-hidden">
                <div className="absolute inset-0 bg-grid opacity-10 pointer-events-none" />
                <div className="relative z-10">
                  <div className="w-20 h-20 border-2 border-border bg-secondary flex items-center justify-center mb-8 mx-auto shadow-[6px_6px_0px_0px_var(--border)]">
                  ...
                  <Button className="bg-black text-white hover:bg-background hover:text-black border-2 border-border rounded-none shadow-[4px_4px_0px_0px_var(--border)] px-8 h-14 font-code font-bold group">
                    CONFIGURE MODULES

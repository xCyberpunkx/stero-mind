...
export default async function DashboardPage() {
  ...
  const widgets = [
    ...
    { title: "Goals Locked", icon: Target, count: goals?.filter(g => !g.is_completed).length || "0", status: "READY" },
  ]
    ...
    <div className="min-h-screen bg-background text-foreground font-display selection:bg-black selection:text-white">
      ...
      <main className="relative pt-32 pb-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Left Column - Core Info & Quick Actions */}
          <div className="md:col-span-4 space-y-8">
            ...
            <div className="border-2 border-black bg-secondary/30 p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <div className="space-y-4">
                <div className="border-2 border-black bg-white p-3 font-code font-bold text-[10px] uppercase">
                  GOAL: {profile.goal}
                </div>
              </div>
            </div>
          ...
          {/* Center Column - Tasks & Goals */}
          <div className="md:col-span-4 space-y-8">
            <div className="border-2 border-black bg-white p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] h-fit">
          ...
          {/* Right Column - Neural Logs & Status */}
          <div className="md:col-span-4 space-y-8">
            ...
            {/* System Status Card */}
            <div className="border-2 border-black bg-black text-white p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)]">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                <h3 className="font-bold uppercase tracking-tighter font-code text-sm">Kernel_Status</h3>
              </div>
              <div className="space-y-2 font-code text-[10px] opacity-70">
                <p>MEM_POOL: ACTIVE</p>
                <p>SYNC_CON: STABLE</p>
                <p>Uptime: {new Date().toLocaleTimeString()}</p>
              </div>
            </div>
          </div>
        </div>
